...
func runRemove(cmd *cobra.Command, args []string) error {
	logFile, _, logOnCliAndFileStart := utils.GetLogWriters("/tmp/grpl_k3d_remove.log")
	...
	defer func() {
		...
		logFile.Close()
		if err != nil {
			utils.ErrorMessage("Failed to remove cluster, please run cat /tmp/grpl_k3d_remove.log for more details")
		}
	}()
